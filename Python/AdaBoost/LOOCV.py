...
def cross_val_predict(KL, Y, estimator, f='predict', cv=None, n_folds=None, score='accuracy', random_state=None):
    return _cross_val (KL, Y, estimator, f, cv, n_folds, score, random_state)
